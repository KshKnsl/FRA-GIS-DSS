...
const SchemeRecommendations = () => {
  ...
  const fetchRecommendations = async () => {
    setLoading(true);
    try {
      const response = await fetch(`http://localhost:4000/api/fra/recommendations/${villageId}`);
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Scheme Recommendations</h1>
        ...
        <Card className="mb-8">
          <CardHeader>
            <CardTitle>Village Profile</CardTitle>
          </CardHeader>
          <CardContent>
